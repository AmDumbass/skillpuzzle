        ...
        if (books.length === 0) {
            ...
            const bookContent = {
                book1: {
                    ...
                    episodes: ["Tập 1: Cảnh giác với người lạ", "Tập 2: An toàn giao thông", "Tập 3: An toàn với ổ điện", "Tập 4: Tránh xa vật sắc nhọn", "Tập 5: Sử dụng công nghệ an toàn"]
                },
                book2: {
                    title: "Chủ đề 2: Chăm sóc bản thân",
                    episodes: ["Tập 1: Cùng đánh răng nào", "Tập 2: Rửa tay sạch, bảo vệ sức khỏe", "Tập 3: Tập dọn đồ chơi", "Tập 4: Phân biệt giày trái, phải", "Tập 5: Học cách đi vệ sinh"]
                },
                book3: {
                    title: "Chủ đề 3: Quản lí cảm xúc",
                    episodes: ["Tập 1: Thật là vui", "Tập 2: Vì sao Zino buồn vậy?", "Tập 3: Zino ơi, đừng tức giận nhé!", "Tập 4: Đừng sợ, mạnh mẽ lên nào", "Tập 5: Hãy nói ra cảm xúc"]
                },
                book4: {
                    title: "Chủ đề 4: Tương tác xã hội",
                    episodes: ["Tập 1: Các bạn nhỏ cùng chia sẻ đồ chơi", "Tập 2: Chơi cùng nhau nào", "Tập 3: Thể hiện nhu cầu", "Tập 4: Học cách chờ đến lượt", "Tập 5: Không dùng bạo lực"]
                },
                book5: {
                    title: "Chủ đề 5: Bảo vệ môi trường",
                    episodes: ["Tập 1: Học cách tái chế", "Tập 2: Đừng xả rác nhé!", "Tập 3: Hãy giữ sông, suối sạch sẽ", "Tập 4: Trồng cây thật là vui", "Tập 5: Tiết kiệm nước thật là tốt"]
                },
                book6: {
                    title: "Chủ đề 6: Kỹ năng giao tiếp",
                    episodes: ["Tập 1: Kỹ năng giao tiếp", "Tập 2: Xin chào và tạm biệt", "Tập 3: Xin lỗi và cảm ơn", "Tập 4: Học cách xưng hô đúng", "Tập 5: Nói đồng ý và từ chối"]
                }
            };
            ...
            books.forEach((book) => {
                ...
                if (content) {
                    const episodesHTML = content.episodes.map(ep => `<li><button>${ep}</button></li>`).join("");
